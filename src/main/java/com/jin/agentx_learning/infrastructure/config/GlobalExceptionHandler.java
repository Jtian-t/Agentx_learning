package com.jin.agentx_learning.infrastructure.config;
...
import com.jin.agentx_learning.infrastructure.exception.EntityNotFoundException;
import com.jin.agentx_learning.infrastructure.exception.ParamValidationException;
...
//    这个注解是 Spring 框架（尤其是 Spring Boot 项目）中 “全局异常处理” 的核心神器。
//    简单来说，它的作用是：专门捕获并处理程序中抛出的特定异常（这里是 BusinessException），防止程序直接崩溃，并给前端返回一个优雅、格式统一的错误提示。
    /** 处理业务异常 */
